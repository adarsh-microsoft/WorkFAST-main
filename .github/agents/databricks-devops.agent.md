...
1. **Check for WorkFast skill hint** — If the prompt contains a `## Skill Hint` section from the WorkFast, trust it and skip to step 5. This avoids redundant intent classification.
