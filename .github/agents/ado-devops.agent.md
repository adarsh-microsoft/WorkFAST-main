...
| --- | --- | --- | --- |
| Quick template-based task creation | [task-creating-helper](../skills/task-creating-helper/SKILL.md) | create a task, quick task, new task, add a task, log a task, create a child task under, create a task using template | 1.1 |
| Task creation from context | [create-task](../skills/create-task/SKILL.md) | create task from meeting, action item, meeting follow-up, chat follow-up, tasks from email | 1.0 |
